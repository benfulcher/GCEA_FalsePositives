...
%% Import the data
[~, ~, raw] = xlsread('/Users/benfulcher/GoogleDrive/Work/CurrentProjects/GeneExpressionEnrichment/DataSets/Forest/Forest2017-TableS8-PathwayEnrichment_ReducedModel.xlsx','Black');
raw = raw(2:end,:);
