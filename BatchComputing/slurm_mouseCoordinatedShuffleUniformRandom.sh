...
#SBATCH --job-name mouseCoordinatedShuffleUniformRandom
...
matlab -nodesktop -r "startup;parpool('local',12); SurrogateEnrichment('mouse',10000,'randomUniform','coordinatedSpatialShuffle');
exit"
