...
#SBATCH --job-name mouseRandomMapNulls
...
matlab -nodesktop -r "startup; parpool('local',12); params = GiveMeDefaultParams('mouse'); params.e.whatEnsemble = 'randomMap'; NullComputation(params); exit"
