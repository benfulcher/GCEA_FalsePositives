...
set jobText = "startup; parpool('local',32);params = GiveMeDefaultParams('human');params.g.whatSurrogate = 'randomMap';params.nulls.customShuffle = 'independentSpatialShuffle';SurrogateEnrichment(params); exit"
