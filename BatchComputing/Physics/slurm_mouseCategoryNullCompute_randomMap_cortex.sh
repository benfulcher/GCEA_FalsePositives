...
#SBATCH --job-name mouseCortexRandomMapNulls
...
matlab -nodesktop -r "startup; parpool('local',12); params = GiveMeDefaultParams('mouse','cortex'); params.e.whatEnsemble = 'randomMap'; NullComputation(params); exit"
