...
set jobText = "startup; parpool('local',12);params = GiveMeDefaultParams('human');params.g.whatSurrogate = 'spatialLag';params.nulls.customShuffle = 'none';SurrogateEnrichment(params); exit"
