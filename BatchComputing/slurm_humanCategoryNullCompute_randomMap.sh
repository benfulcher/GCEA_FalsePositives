...
#SBATCH --job-name humanRandomMapNull
...
matlab -nodesktop -r "startup; parpool('local',12); params = GiveMeDefaultParams('human'); params.e.whatEnsemble = 'randomMap'; NullComputation(params); exit"
