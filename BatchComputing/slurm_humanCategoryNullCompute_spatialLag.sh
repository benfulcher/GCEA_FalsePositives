...
#SBATCH --job-name humanSpatialLagNull
...
matlab -nodesktop -r "startup; parpool('local',12); params = GiveMeDefaultParams('human'); params.e.whatEnsemble = 'customEnsemble'; NullComputation(params); exit"
